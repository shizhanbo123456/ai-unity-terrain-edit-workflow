...
| Billboard / LOD | 相关 Prefab 全部配置（cross / linear 面片 + LOD 切换阈值） |
...
2. 按对应级别表格逐项核对；L0 重点核对数据文件清单，L2 重点核对覆盖率与 bridge 确认记录。
